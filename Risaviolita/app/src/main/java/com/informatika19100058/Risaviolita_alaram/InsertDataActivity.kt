...
import com.informatika19100058.Risaviolita_alaram.adapter.ListContent
import com.informatika19100058.Risaviolita_alaram.network.koneksi
...
class InsertDataActivity : AppCompatActivity() {
    ...
    fun actionData(hari: String, jam_mulai: String,jam_berhenti: String) {
        koneksi.service.insertBarang(hari, jam_mulai,jam_berhenti)
            .enqueue(object : Callback<com.informatika19100058.Risaviolita_alaram.adapter.ListContent.responactioninfak> {
                override fun onFailure(call: Call<com.informatika19100058.Risaviolita_alaram.adapter.ListContent.responactioninfak>, t: Throwable) {
                    Log.d("pesan1", t.localizedMessage)
                }

                override fun onResponse(
                    call: Call<com.informatika19100058.Risaviolita_alaram.adapter.ListContent.responactioninfak>,
                    response: Response<com.informatika19100058.Risaviolita_alaram.adapter.ListContent.responactioninfak>
                ) {
